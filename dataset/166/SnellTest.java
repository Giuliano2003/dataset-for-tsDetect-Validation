...
/* https://github.com/hhaslam11/Text-Fighter/blob/ae0fe3e4fba1e8ebb880a2ab0572069b21e8618f/src/com/hotmail/kalebmarc/textfighter/main/FoodTest.java#L46 */
...
public class CheatsTest {
	...
	public void testCheatGatewaygivemeitall() {
		...
		Ui.print("Type to test");
		
		ByteArrayInputStream chooseIn = new ByteArrayInputStream("givemeitall"); // Set input stream to pick cheat automatically
